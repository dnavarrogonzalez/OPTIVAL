...
P.J. Ferrando, D. Navarro-González, F. Morales-Vives, Revisiting the test-length and validity problem from a model-based view: A proposal and recommendations, Anales de Psicología (in-press).
